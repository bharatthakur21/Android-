...
public class SecondPageResponse {
    @SerializedName("status")
    @Expose
    private String status;
    @SerializedName("data")
    @Expose
    private List<SampleClass.Datum> data = null;
    ...
    public List<SampleClass.Datum> getData() {
        return data;
    }

    public void setData(List<SampleClass.Datum> data) {
        this.data = data;
    }
